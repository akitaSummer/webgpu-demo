...
import { CubeData1, SphereData } from "./vertex_data";
import { CreateShapeWithTexture } from "./texture";
import sphereShader from "./sphere_shader.wgsl";
import cubeShader from "./cube_shader.wgsl";
import {
  CreateAnimation,
  CreateGPUBuffer,
  CreateGPUBufferUint,
...
export const CreateObjects = async () => {
  ...
  function draw() {
    ...
    device.queue.writeBuffer(
      uniformBuffer2,
      0,
      modelViewProjectionMatrix2 as ArrayBuffer
    );
