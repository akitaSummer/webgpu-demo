...
export const CreateSurfaceWithColormap = async (
  ...
  device.queue.writeBuffer(
    meshColorUniformBuffer,
    0,
    new Float32Array([...meshColor, 1.0])
  );
  ...
  function draw() {
    ...
    renderPassDescription.colorAttachments[0].resolveTarget =
      contextTexture.createView();
